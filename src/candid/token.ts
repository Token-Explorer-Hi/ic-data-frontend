...
export type Result = { ok: Page } | { err: CommonError };
export type Result_1 = { ok: bigint } | { err: CommonError };
export type Result_2 = { ok: Balance__1 } | { err: CommonError__1 };
export type Result_3 = { ok: boolean } | { err: CommonError__1 };
export type Result_4 = { ok: Metadata } | { err: CommonError__1 };
export type Result_5 = { ok: string } | { err: CommonError__1 };
export type Result_6 = { ok: Page_1 } | { err: CommonError };
export type Result_7 = { ok: bigint } | { err: CommonError__1 };
